      ...
      <div className="mx-2 my-4 border-t">
        ...
        <Accordion transition transitionTimeout={200}>
          ...
          <AccordionItem header="Can I pay the tuition fee in installments?">
            Yes, Contact to SSquareIt for more information
          </AccordionItem>

          <AccordionItem header="Which one is the ideal course for me?">
            Personalized Guidance: Benefit from one-to-one career consultations
            with Shubham Sir visit our office to shape your professional future.
          </AccordionItem>
